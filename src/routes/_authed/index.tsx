...
/**
 * `/` — the dashboard (SPEC §12.1; WP-Home owns this route from the feature
 * wave on). SSR: the trip list is fetched in the loader and dehydrated, with
 * "today" in the viewer's zone so the first paint already splits next /
 * past trips right (DASH-03); in the browser the loader asks the clock.
 */
